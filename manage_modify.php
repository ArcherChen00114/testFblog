...
if($rows){
    ...
    foreach (range(1,9) as $num){
        if ($html['face']=='face/00'.$num.'.jpg'){
       $html['face_html'].='<option value="face/00'.$num.'.jpg" selected="selected">face/00'.$num.'.jpg</option>';
        }else {
            $html['face_html'].='<option value="face/00'.$num.'.jpg" >face/00'.$num.'.jpg</option>';
            } 
    }
    foreach (range(10,99) as $num){
        if ($html['face']=='face/0'.$num.'.jpg'){
            $html['face_html'].='<option value="face/0'.$num.'.jpg" selected="selected">face/0'.$num.'.jpg</option>';
        }else {
