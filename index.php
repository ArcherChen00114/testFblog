...
*     do it in night
*     8/16----------19:55
*     74:create album picture list to store picture
*     store pictures in those lists
*     75:show thumb image(back to code.php, thumb image cant show)
*     76:
 *     8/18 16:43
 *     80:secret xml
 *        unlock design//album password setting
 *     9/21 16:17
 *      article_modify.php need one more modify confirmation before delete
 *      and delete reply after delete that post
 */    
